...
const Team = ()=>{
    return (<div className="Team">
        ...
        <Card3 title={"Dixa"} id={"ID : 54829"} src={"../images/ProfilePic.png"}></Card3>
        <Card3 title={"Harshita Martolia"} id={"ID : 54832"} src={"../images/ProfilePic.png"}></Card3>
        <Card3 title={"Sunil Chand I'd "} id={"ID : 56645"} src={"../images/ProfilePic.png"}></Card3>
        </div>
    </div>)
}
